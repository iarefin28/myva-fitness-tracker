...
const styles = StyleSheet.create({
  ...
  heroTitle: { fontSize: 22, fontWeight: "800", ...typography.body },
  ...
  typeText: { fontSize: 12, fontWeight: "700", letterSpacing: 0.3, ...typography.label },
  metaText: { fontSize: 12, ...typography.body },
  statsRow: { flexDirection: "row", gap: 10 },
  statCard: { flex: 1, borderWidth: 1, borderRadius: 14, padding: 12, gap: 4 },
  statLabel: { fontSize: 12, fontWeight: "700", letterSpacing: 0.3, ...typography.label },
  statValue: { fontSize: 20, fontWeight: "800", ...typography.body },
  statHint: { fontSize: 12, ...typography.body },
  panel: { borderWidth: 1, borderRadius: 16, padding: 16, gap: 8 },
  label: { fontSize: 12, fontWeight: "700", letterSpacing: 0.4, ...typography.label },
  body: { fontSize: 15, lineHeight: 22, ...typography.body },
  title: { fontSize: 20, fontWeight: "800", marginBottom: 6, ...typography.body },
