...
export const EXERCISE_TYPE_MAP: Record<string, "bodyweight" | "weighted" | "duration" | "weighted duration" | "weighted distance"> = {
  ...
  "Smith Machine Bench Press (Incline)": "weighted",
  "Dumbbell Flys": "weighted",
  "Pec Deck Chest Fly Machine": "weighted",
  "Machine Row (Hammer Strength)": "weighted",
  "Cable Lateral Raise": "weighted",
  "Machine Lateral Raise": "weighted",
  "Cable Rear Delt Fly (Reverse Cable Cross)": "weighted",
  "Reverse Pec Deck Machine": "weighted",
  "Incline Reverse Fly (Chest on Incline Bench)": "weighted",
  "Barbell Shrugs": "weighted",
  "EZ Bar Curl": "weighted",
  "Hammer Curl (Neutral Grip)": "weighted",
  "Preacher Curl (Barbell)": "weighted",
  "Preacher Curl (Dumbbell)": "weighted",
  "Incline Dumbbell Curl": "weighted",
  "Rope Cable Hammer Curl": "weighted",
  "Reverse Curl (Overhand Grip)": "weighted",
  "Machine Bicep Curl": "weighted",
  "Overhead Triceps Extension (Dumbbell)": "weighted",
  "Overhead Cable Triceps Extension": "weighted",
  "Dumbbell Kickbacks": "weighted",
  "One-Arm Cable Pushdowns": "weighted",
  "Machine Triceps Dip Press": "weighted",
  "Hack Squat": "weighted",
  "Smith Machine Squat": "weighted"
};
